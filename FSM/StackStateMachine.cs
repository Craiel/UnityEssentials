namespace Craiel.UnityEssentials.FSM
{
    using System.Collections.Generic;
    using Contracts;

    /// <summary>
    /// A <see cref="Craiel.UnityEssentials.Contracts.IStateMachine{T,TS}"/> implementation that keeps track of all previous <see cref="Craiel.UnityEssentials.Contracts.IState{T}"/> via a stack. This makes sense for example
    ...
    /// anytime, via <see cref="Craiel.UnityEssentials.Contracts.IStateMachine{T,TS}.RevertToPreviousState"/>.
    /// </summary>
